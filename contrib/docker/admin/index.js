...
const app               = express()
const wokas          = require('./availableWokas.json')
...
app.get("/api/map", (req, res) => {
    ...
    res.send(JSON.stringify({
        mapUrl : "https://maps.herginnies.world/map1/starter/map.json",
        group : "wa",
        authenticationMandatory: false,
        mucRooms: null,
        redirectUrl: "https://play.herginnies.world/_/global/maps.herginnies.world/map1/starter/map.json"
    }
    ))
})
